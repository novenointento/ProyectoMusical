...
6. **Implement tasks (loop until done or blocked)**
   ...
   **For Manual Pruebas Tasks (MANDATORY - AGENT MUST EXECUTE)**:
   - **Manual Endpoint Pruebas with curl**: If the task involves testing endpoints:
   ...
   - **E2E Pruebas with Playwright MCP**: If the task involves frontend/E2E testing:
   ...
   **Pause if:**
   ...
   - Implementación reveals a design issue → suggest updating artifacts
...
**Output On Pause (Incidencia Encountered)**

```
## Implementación Paused

**Change:** <change-name>
**Schema:** <schema-name>
**Progress:** 4/7 tasks complete

### Incidencia Encountered
...
- Actualizar task checkbox immediately after completing each task AND verifying all tests pass
