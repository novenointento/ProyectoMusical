...
4. **Crear artifacts in sequence until apply-ready**
   ...
   a. **For each artifact that is `ready` (dependencies satisfied)**:
      ...
      - Crear the artifact file using `template` as the structure
...
- Prompt: "Ejecutar `/opsx:apply` or ask me to implement to start working on the tasks."
...
**Guardrails**
- Crear ALL artifacts needed for implementation (as defined by schema's `apply.requires`)
